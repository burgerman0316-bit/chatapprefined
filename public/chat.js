...
// =========================================================================
// *** Using the Railway URL for deployment stability ***
...
socket.on('clear messages', function() {
    ...
    // Only show the confirmation message if the current client is a Mod
    if (isMod) {
        appendMessage('Chat history has been cleared by a moderator.', 'system');
    }
    // Non-mods will simply see the chat clear without confirmation text.
});
